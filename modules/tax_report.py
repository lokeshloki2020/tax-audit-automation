...
def apply_tax_report_style():
    ...
    .tax-report-hero {
        padding: 24px;
        border-radius: 22px;
        background: linear-gradient(135deg, #7f1d1d, #1d4ed8, #0f766e);
        color: white;
        margin-bottom: 24px;
...
def show_tax_report():
    ...
    <div class="tax-report-hero">
        ...
        <p>Prepare report-level audit details and clause-wise Form 3CD reporting linked with Tax Audit Applicability.</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    def open_clause_dialog(clause_no):
        ...
        if st.button("💾 Save Clause", key=f"save_clause_{selected_client}_{selected_ay}_{clause_no}"):
    ...
    st.caption(
        "This module prepares structured working data for Form 3CA/3CB and Form 3CD. "
        "Final JSON utility compatibility can be added in the next enhancement."
    )